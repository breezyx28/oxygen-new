...
export const IntelligentRountingSkillsCard1 = ({
  icon,
  title,
  text,
}: {
...
export const IntelligentRountingSkillsCard2 = ({
  title,
  text,
}: {
  title: string;
...
export const IntelligentRountingSkillsToggler = () => {
  ...
  const data = [
    {
      ...
      content: (
        <IntelligentRountingSkillsCard2
